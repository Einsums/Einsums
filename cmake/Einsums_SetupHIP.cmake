...
if (EINSUMS_WITH_HIP AND NOT TARGET roc::rocblas)
    ...
    set(CMAKE_HIP_STANDARD_REQUIRED OFF)
    set(CMAKE_HIP_EXTENSIONS OFF)

    if(NOT CMAKE_HIP_COMPILER_ROCM_ROOT AND NOT HIP_ROCM_ROOT)
    message(WARNING "CMAKE_HIP_COMPILER_ROCM_ROOT is not set. CMake may not be able to find all of the libraries needed for HIP."
