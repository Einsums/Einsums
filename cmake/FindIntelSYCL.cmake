...
# list(APPEND dpcpp_root_hints ${DPCPP_ROOT} $ENV{DPCPP_ROOT}) set(original_cmake_prefix_path
# ${CMAKE_PREFIX_PATH}) if(dpcpp_root_hints) list(INSERT CMAKE_PREFIX_PATH 0 ${dpcpp_root_hints})
# else() message("DPCPP_ROOT prefix path hint is not defiend") endif()
