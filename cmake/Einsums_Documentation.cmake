...
if (EINSUMS_WITH_DOCUMENTATION)
    ...
    if (NOT Sphinx_FOUND)
        ...
        # elseif(NOT Breathe_FOUND) einsums_error( "Breathe is unavailable, sphinx documentation
        # generation disabled. Set Breathe_APIDOC_ROOT to your breathe-apidoc installation directory." )
        # set(EINSUMS_WITH_DOCUMENTATION OFF)
