...
void create_J(Tensor<double, 2> &J, Tensor<double, 2> const &D, Tensor<double, 4> const &TEI) {
    tensor_algebra::einsum(0.0, Indices{index::mu, index::nu}, &J, 2.0, Indices{index::lambda, index::sigma}, D,
                           Indices{index::mu, index::nu, index::lambda, index::sigma}, TEI);
}

void create_K(Tensor<double, 2> &K, Tensor<double, 2> const &D, Tensor<double, 4> const &TEI) {
    tensor_algebra::einsum(0.0, Indices{index::mu, index::nu}, &K, -1.0, Indices{index::lambda, index::sigma}, D,
...
void create_K_sorted(Tensor<double, 2> &K, Tensor<double, 2> const &D, Tensor<double, 4> const &TEI, Tensor<double, 4> &sorted_TEI) {
    tensor_algebra::permute(Indices{index::mu, index::nu, index::lambda, index::sigma}, &sorted_TEI, Indices{index::mu, index::lambda, index::nu, index::sigma}, TEI);
    tensor_algebra::einsum(0.0, Indices{index::mu, index::nu}, &K, -1.0, Indices{index::lambda, index::sigma}, D,
                           Indices{index::mu, index::nu, index::lambda, index::sigma}, sorted_TEI);
}
