               ...
               const stride_vector& stride_C_AC)
{
    ...
    stl_ext::erase(reorder_AC, [&](int x) { return x == unit_AC; });
    stl_ext::erase(reorder_AB, [&](int x) { return x == unit_AB; });
    ...
    {
        index_iterator<1,2> iter_AB(stl_ext::permuted(len_AB, reorder_AB),
                             stl_ext::permuted(stride_A_AB, reorder_AB),
                             stl_ext::permuted(stride_B_AB, reorder_AB));

        index_iterator<1,2> iter_AC(stl_ext::permuted(len_AC, reorder_AC),
               ...
               const stride_vector& stride_C_BC)
{
    ...
    stl_ext::erase(reorder_AC, [&](int x) { return x == unit_AC; });
    stl_ext::erase(reorder_BC, [&](int x) { return x == unit_BC; });
    ...
    [&](len_type l_min, len_type l_max)
    {
        index_iterator<1,3> iter_ABC(stl_ext::appended(stl_ext::permuted(len_AC, reorder_AC),
               ...
               const stride_vector& stride_C_ABC)
{
    ...
    [&](len_type l_min, len_type l_max)
    {
        ...
        index_iterator<1,3> iter_ABC(stl_ext::appended(stl_ext::permuted(len_ABC, reorder_ABC),
               ...
               const stride_vector& stride_C_ABC)
{
    ...
    [&](len_type l_min, len_type l_max)
    {
        ...
        index_iterator<1,3> iter_ABC(stl_ext::permuted(len_ABC, reorder_ABC),
               ...
               const stride_vector& stride_C_ABC_)
{
    ...
    [&](marray<T>& ar, marray<T>& br, marray<T>& cr)
    {
        ...
        index_iterator<1,3> it(len_ABC, stride_A_ABC, stride_B_ABC, stride_C_ABC);
              ...
              const stride_vector& stride_C_ABC)
{
    ...
    [&](len_type n_min, len_type n_max)
    {
        ...
        index_iterator<1,2> iter_AB(len_AB, stride_A_AB, stride_B_AB);
        index_iterator<1,2> iter_AC(len_AC, stride_A_AC, stride_C_AC);
        index_iterator<1,2> iter_BC(len_BC, stride_B_BC, stride_C_BC);
        index_iterator<1,3> iter_ABC(len_ABC, stride_A_ABC, stride_B_ABC, stride_C_ABC);
