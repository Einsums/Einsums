...
template <typename T>
void scale(T alpha, marray_view<T> A, const label_type* idx_A)
{
...
template <typename T>
void scale(const communicator& comm, T alpha, marray_view<T> A, const label_type* idx_A)
{
    tblis_tensor A_s(alpha, A);
...
template <typename T>
void scale(T alpha, dpd_marray_view<T> A, const label_type* idx_A)
{
    parallelize
    (
...
template <typename T>
void scale(T alpha, indexed_marray_view<T> A, const label_type* idx_A)
{
    parallelize
    (
        [&](const communicator& comm)
...
template <typename T>
void scale(T alpha, indexed_dpd_marray_view<T> A, const label_type* idx_A)
{
    parallelize
    (
        [&](const communicator& comm)
