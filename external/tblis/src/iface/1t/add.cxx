...
void add(const communicator& comm,
         ...
         T  beta, dpd_marray_view<      T> B, const label_type* idx_B_)
{
...
void add(const communicator& comm,
         ...
         T  beta, indexed_marray_view<      T> B, const label_type* idx_B_)
{
    unsigned ndim_A = A.dimension();
    unsigned ndim_B = B.dimension();
...
void add(const communicator& comm,
         ...
         T  beta, indexed_dpd_marray_view<      T> B, const label_type* idx_B_)
{
    unsigned nirrep = A.num_irreps();
    TBLIS_ASSERT(B.num_irreps() == nirrep);
