...
template <typename T>
void dot(marray_view<const T> A, const label_type* idx_A,
         marray_view<const T> B, const label_type* idx_B, T& result)
{
    tblis_tensor A_s(A);
    tblis_tensor B_s(B);
...
template <typename T>
T dot(marray_view<const T> A, const label_type* idx_A,
      marray_view<const T> B, const label_type* idx_B)
{
    T result;
...
template <typename T>
void dot(dpd_marray_view<const T> A, const label_type* idx_A,
         dpd_marray_view<const T> B, const label_type* idx_B, T& result)
{
    parallelize
    (
...
template <typename T>
T dot(dpd_marray_view<const T> A, const label_type* idx_A,
...
template <typename T>
void dot(indexed_marray_view<const T> A, const label_type* idx_A,
         indexed_marray_view<const T> B, const label_type* idx_B, T& result)
{
    parallelize
    (
...
template <typename T>
T dot(indexed_marray_view<const T> A, const label_type* idx_A,
...
template <typename T>
void dot(indexed_dpd_marray_view<const T> A, const label_type* idx_A,
         indexed_dpd_marray_view<const T> B, const label_type* idx_B, T& result)
{
    parallelize
    (
...
template <typename T>
T dot(indexed_dpd_marray_view<const T> A, const label_type* idx_A,
