...
template <typename T>
void reduce(reduce_t op, marray_view<const T> A, const label_type* idx_A, T& result, len_type& idx)
{
    tblis_tensor A_s(A);
...
template <typename T>
void reduce(const communicator& comm, reduce_t op, marray_view<const T> A, const label_type* idx_A,
...
template <typename T>
std::pair<T,len_type> reduce(reduce_t op, marray_view<const T> A, const label_type* idx_A)
{
...
std::pair<T,len_type> reduce(const communicator& comm, reduce_t op,
                             marray_view<const T> A, const label_type* idx_A)
{
    std::pair<T,len_type> result;
...
template <typename T>
void reduce(reduce_t op, dpd_marray_view<const T> A, const label_type* idx_A,
            T& result, len_type& idx)
{
    parallelize
    (
...
template <typename T>
std::pair<T,len_type> reduce(reduce_t op, dpd_marray_view<const T> A, const label_type* idx_A)
{
    std::pair<T,len_type> result;
    reduce(op, A, idx_A, result.first, result.second);
    return result;
...
template <typename T>
void reduce(reduce_t op, indexed_marray_view<const T> A, const label_type* idx_A,
            T& result, len_type& idx)
{
    parallelize
    (
...
template <typename T>
std::pair<T,len_type> reduce(reduce_t op, indexed_marray_view<const T> A, const label_type* idx_A)
{
    std::pair<T,len_type> result;
    reduce(op, A, idx_A, result.first, result.second);
    return result;
...
template <typename T>
void reduce(reduce_t op, indexed_dpd_marray_view<const T> A, const label_type* idx_A,
            T& result, len_type& idx)
{
    parallelize
    (
...
template <typename T>
std::pair<T,len_type> reduce(reduce_t op, indexed_dpd_marray_view<const T> A, const label_type* idx_A)
{
    std::pair<T,len_type> result;
    reduce(op, A, idx_A, result.first, result.second);
    return result;
