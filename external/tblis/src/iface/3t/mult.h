...
template <typename T>
void mult(T alpha, marray_view<const T> A, const label_type* idx_A,
                   marray_view<const T> B, const label_type* idx_B,
          T  beta,       marray_view<T> C, const label_type* idx_C)
{
...
template <typename T>
void mult(T alpha, dpd_marray_view<const T> A, const label_type* idx_A,
                   dpd_marray_view<const T> B, const label_type* idx_B,
          T  beta, dpd_marray_view<      T> C, const label_type* idx_C)
{
    parallelize
...
template <typename T>
void mult(T alpha, indexed_marray_view<const T> A, const label_type* idx_A,
                   indexed_marray_view<const T> B, const label_type* idx_B,
          T  beta, indexed_marray_view<      T> C, const label_type* idx_C)
{
    parallelize
...
template <typename T>
void mult(T alpha, indexed_dpd_marray_view<const T> A, const label_type* idx_A,
                   indexed_dpd_marray_view<const T> B, const label_type* idx_B,
          T  beta, indexed_dpd_marray_view<      T> C, const label_type* idx_C)
{
    parallelize
