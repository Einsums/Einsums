...
#include "../external/marray/include/dpd/dpd_marray.hpp"
#include "../external/marray/include/indexed/indexed_marray.hpp"
#include "../external/marray/include/indexed_dpd/indexed_dpd_marray.hpp"
...
using tensor = MArray::marray<T, 1, Allocator>;
