...
class dpd_tensor_matrix : public abstract_matrix<T>
{
    ...
    public:
        ...
        dpd_tensor_matrix(dpd_marray_view<T>& other,
                          const U& row_inds,
                          const V& col_inds,
                          unsigned col_irrep,
                          const W& extra_inds,
        ...
        template <typename U, typename V, typename W, typename X, typename Y>
        dpd_tensor_matrix(dpd_marray_view<const T>& other,
                          const U& row_inds,
                          const V& col_inds,
                          unsigned col_irrep,
                          const W& extra_inds,
                          ...
                          bool pack_row_3d = false,
                          bool pack_col_3d = false)
        : dpd_tensor_matrix(reinterpret_cast<dpd_marray_view<T>&>(other),
