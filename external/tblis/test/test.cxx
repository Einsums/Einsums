...
#define FOREACH_TYPE(T) \
template void random_tensor(stride_type N, unsigned d, const vector<len_type>& len_min, marray<T>& A);
#include "configs/foreach_type.h"
...
#define FOREACH_TYPE(T) \
template void random_tensor(stride_type N, unsigned d, unsigned nirrep, const vector<len_type>& len_min, dpd_marray<T>& A);
#include "configs/foreach_type.h"
...
#define FOREACH_TYPE(T) \
template void random_tensor(stride_type N, unsigned d, const vector<len_type>& len_min, indexed_marray<T>& A);
#include "configs/foreach_type.h"
...
#define FOREACH_TYPE(T) \
template void random_tensor(stride_type N, unsigned d, unsigned nirrep, const vector<len_type>& len_min, indexed_dpd_marray<T>& A);
#include "configs/foreach_type.h"
...
#define FOREACH_TYPE(T) \
template void random_tensor(stride_type N, unsigned d, const vector<len_type>& len_min, dpd_marray<T>& A);
#include "configs/foreach_type.h"
...
#define FOREACH_TYPE(T) \
template void random_tensor(stride_type N, unsigned d, const vector<len_type>& len_min, indexed_dpd_marray<T>& A);
#include "configs/foreach_type.h"
