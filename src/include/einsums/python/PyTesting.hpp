...
struct EINSUMS_EXPORT BadBuffer {
  ...
  public:
     ...
     */
    void set_dim(int i, size_t dim) THROWS(std::out_of_range);
     ...
     */
    void set_stride(int i, size_t stride) THROWS(std::out_of_range);
