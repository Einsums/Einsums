...
#include "cblas.h"
#include "cblas_f77.h"
void cblas_ztbmv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N,
...
#define F77_incX incX
    ...
    if (layout == CblasColMajor) {
        ...
        F77_DI = C2F_CHAR(&DI);
#endif
        F77_ztbmv(F77_UL, F77_TA, F77_DI, &F77_N, &F77_K, A, &F77_lda, X, &F77_incX);
