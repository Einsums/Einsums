...
#include <stdio.h>
#include <stdlib.h>
void cblas_zhpmv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const void *alpha, const void *AP, const void *X,
...
#define F77_incY incY
    ...
    if (layout == CblasColMajor) {
        ...
        F77_UL = C2F_CHAR(&UL);
#endif
        F77_zhpmv(F77_UL, &F77_N, alpha, AP, X, &F77_incX, beta, Y, &F77_incY);
