...
#include "cblas.h"
#include "cblas_f77.h"
void cblas_ctbsv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N,
                 const CBLAS_INT K, const void *A, const CBLAS_INT lda, void *X, const CBLAS_INT incX) {
    char TA;
    char UL;
    char DI;
#ifdef F77_CHAR
...
#define F77_incX incX
    ...
    if (layout == CblasColMajor) {
        ...
        F77_DI = C2F_CHAR(&DI);
#endif
        F77_ctbsv(F77_UL, F77_TA, F77_DI, &F77_N, &F77_K, A, &F77_lda, X, &F77_incX);
        ...
        cblas_xerbla(1, "cblas_ctbsv", "Illegal layout setting, %d\n", layout);
    CBLAS_CallFromC = 0;
    RowMajorStrg = 0;
    return;
}
