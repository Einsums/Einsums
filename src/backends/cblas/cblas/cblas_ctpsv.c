...
#include "cblas.h"
#include "cblas_f77.h"
void cblas_ctpsv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N,
...
#define F77_incX incX
    ...
    if (layout == CblasColMajor) {
        ...
        cblas_xerbla(1, "cblas_ctpsv", "Illegal layout setting, %d\n", layout);
    CBLAS_CallFromC = 0;
    RowMajorStrg = 0;
    return;
}
