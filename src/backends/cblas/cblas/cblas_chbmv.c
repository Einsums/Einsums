...
#include <stdio.h>
#include <stdlib.h>
void cblas_chbmv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const CBLAS_INT K, const void *alpha, const void *A,
...
#define F77_incY incY
    ...
    if (layout == CblasColMajor) {
        ...
        F77_UL = C2F_CHAR(&UL);
#endif
        F77_chbmv(F77_UL, &F77_N, &F77_K, alpha, A, &F77_lda, X, &F77_incX, beta, Y, &F77_incY);
