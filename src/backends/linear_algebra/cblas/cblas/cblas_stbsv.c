...
#include "cblas.h"
#include "cblas_f77.h"
void cblas_stbsv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_TRANSPOSE TransA, const CBLAS_DIAG Diag, const CBLAS_INT N,
                 const CBLAS_INT K, const float *A, const CBLAS_INT lda, float *X, const CBLAS_INT incX) {
    char TA;
    char UL;
    char DI;
#ifdef F77_CHAR
...
#define F77_incX incX
    ...
    if (layout == CblasColMajor) {
        ...
        cblas_xerbla(1, "cblas_stbsv", "Illegal layout setting, %d\n", layout);
    CBLAS_CallFromC = 0;
    RowMajorStrg = 0;
    return;
}
