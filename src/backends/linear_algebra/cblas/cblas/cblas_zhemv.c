...
#include <stdio.h>
#include <stdlib.h>
void cblas_zhemv(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const void *alpha, const void *A, const CBLAS_INT lda,
...
#define F77_incY incY
    ...
    if (layout == CblasColMajor) {
        ...
        F77_UL = C2F_CHAR(&UL);
#endif
        F77_zhemv(F77_UL, &F77_N, alpha, A, &F77_lda, X, &F77_incX, beta, Y, &F77_incY);
