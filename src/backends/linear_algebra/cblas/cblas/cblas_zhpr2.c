...
#include <stdio.h>
#include <stdlib.h>
void cblas_zhpr2(const CBLAS_LAYOUT layout, const CBLAS_UPLO Uplo, const CBLAS_INT N, const void *alpha, const void *X,
...
#define F77_incY incy
    ...
    double *x = (double *)X, *xx = (double *)X, *y = (double *)Y, *yy = (double *)Y, *stx, *sty;
